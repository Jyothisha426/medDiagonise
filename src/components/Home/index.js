...
const Home = () => {
  ...
  if (jwtToken === undefined) {
    // Optionally, you can return null or a loader while the redirection happens
    return null;
  }
    ...
    <div>
      ...
      <div className="home-container">
        <h1 className="home-heading">
          MedDiagnose: Instant Symptom Diagnosis & Medication Suggestions
        </h1>
        <p className="home-description">
          MedDiagnose is your go-to platform for quick and accurate symptom diagnosis and personalized medication suggestions.
          ...
          MedDiagnose ensures precise recommendations tailored to your specific symptoms.
        </p>
      </div>
      <div className="features-container">
        ...
        <div className="features-list">
          ...
          <div className="each-feature">
            ...
            <p className="feature-description">Your symptoms will be studied thoroughly and the disease diagnosed will be clearly displayed.</p>
          </div>
          <div className="each-feature">
